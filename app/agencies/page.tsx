...
export default function AgenciesPage() {
  ...
  return (
    <main className="agency-page"><header className="site-header"><Link className="wordmark" href="/">Public service dependency atlas</Link><nav aria-label="Page navigation"><Link href="/register">Gap register</Link><Link href="/">Atlas</Link></nav><span className="schema-pill">Publish-this checklist</span></header>
      <section className="agency-hero"><p className="eyebrow">A constructive one-pager</p><h1>For the agencies named here</h1><p>Every item in this register can be made easier for citizens by publishing one clear, current procedure. That is the cheapest possible fix: publish a document, close a gap. Under Section 4(1)(b) of the RTI Act 2005, public authorities are already expected to proactively publish their procedures.</p><Link className="primary-link" href="/register">View the public register <span>→</span></Link></section>
