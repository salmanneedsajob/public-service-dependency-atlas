...
export interface Ledger {
  ...
  nodes: Array<{ id: string; label: string; kind: string; ownerAgencyId?: string; summary: string; requiredState: string; checks: Detail[]; failureSignals: Detail[]; recoveries: Detail[]; researchedNoSourceFound?: Array<'checks' | 'failureSignals' | 'recoveries'>; scenarioIds: string[]; claimIds: string[]; status: RecordStatus; displayOrder: number }>;
